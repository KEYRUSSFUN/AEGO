...
const advMenuBottom = document.querySelector('.advanced-menu-bottom.menu-bottom');
const advMenuCalc = document.querySelector('.advanced-menu-bottom-calculation');
...
headerBurger.addEventListener('click', () => {
   ...
   advMenuBottom.classList.toggle('active');
   advMenuCalc.classList.toggle('active');
